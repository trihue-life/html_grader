#!/usr/bin/env python3
"""
Build EXERCISES data v2: mỗi criteria có checks[] gắn trực tiếp với điểm số.
Engine sẽ chạy từng check, cộng điểm khi PASS.
Tổng điểm mỗi bài = 10đ.

Cấu trúc criteria mới:
{
  "name": "Tên tiêu chí",
  "points": 2.5,          # điểm tối đa của tiêu chí này
  "checks": [             # danh sách kiểm tra, mỗi check = 1 phần điểm
    {
      "type": "has_doctype",          # kiểm tra DOCTYPE
      "points": 0.5,
      "label": "Có <!DOCTYPE html>",
      "hint": "Thêm <!DOCTYPE html> vào đầu file"
    },
    {
      "type": "has_tag",              # kiểm tra có thẻ
      "tag": "html",
      "points": 0.5,
      "label": "Có thẻ <html>",
      "hint": "Bọc nội dung trong <html>...</html>"
    },
    {
      "type": "has_attr",             # kiểm tra thuộc tính
      "tag": "img",
      "attr": "alt",
      "points": 0.5,
      "label": "<img> có thuộc tính alt",
      "hint": "Thêm alt=\"mô tả\" vào <img>"
    },
    {
      "type": "attr_value",           # kiểm tra giá trị thuộc tính
      "tag": "input",
      "attr": "type",
      "value": "text",
      "points": 0.5,
      "label": "<input> có type=\"text\"",
      "hint": "Thêm type=\"text\" vào <input>"
    },
    {
      "type": "has_bool_attr",        # kiểm tra boolean attribute
      "tag": "video",
      "attr": "autoplay",
      "points": 0.5,
      "label": "<video> có autoplay",
      "hint": "Thêm autoplay vào <video>"
    },
    {
      "type": "tag_count",            # kiểm tra số lượng thẻ
      "tag": "li",
      "min": 3,
      "points": 0.5,
      "label": "Có ít nhất 3 thẻ <li>",
      "hint": "Thêm ít nhất 3 <li> vào danh sách"
    },
    {
      "type": "no_syntax_error",      # không có lỗi cú pháp
      "points": 1.0,
      "label": "Không có lỗi cú pháp",
      "hint": "Kiểm tra thẻ mở/đóng và dấu nháy"
    }
  ]
}
"""
...
def syntax_criteria(points=1.5):
    ...
    return {
        ...
        "points": points,
        "checks": [
            {"type": "no_syntax_error", "points": points * 0.7, "label": "Không có lỗi thẻ đóng/mở", "hint": "Mỗi thẻ mở phải có thẻ đóng tương ứng"},
            {"type": "no_quote_error", "points": points * 0.3, "label": "Thuộc tính có dấu nháy kép", "hint": "Dùng dấu nháy kép: attr=\"value\""},
        ]
    }
...
EXERCISES = [
    ...
    },
    {
        ...
        "description": "Tạo trang hiển thị bài thơ/bài hát với <code>&lt;h1&gt;</code> tên bài, <code>&lt;h2&gt;</code> tác giả, <code>&lt;p&gt;</code> các đoạn thơ, <code>&lt;em&gt;</code> hoặc <code>&lt;strong&gt;</code> nhấn mạnh.",
    ...
    },
    {
        ...
        "description": "Tạo thực đơn nhà hàng với <code>&lt;h1&gt;</code> tên nhà hàng, <code>&lt;h2&gt;</code> danh mục, <code>&lt;ol&gt;</code> danh sách món ăn có thứ tự, <code>&lt;strong&gt;</code> tên món.",
    ...
    {
        "id": "f2_apply1",
        "group": "F2 — Liên kết & Hình ảnh",
        "title": "F2 - Vận dụng 1: Trang ảnh du lịch",
        "description": "Tạo trang ảnh du lịch với <code>&lt;h1&gt;</code> tiêu đề, ít nhất 3 <code>&lt;img&gt;</code> có <code>src</code> và <code>alt</code>, <code>&lt;p&gt;</code> mô tả dưới mỗi ảnh.",
        "required_tags": ["h1", "img", "p"],
        "criteria": [
            struct_criteria(2.5),
            {
                "name": "2. Thẻ ảnh bắt buộc",
                "points": 5.0,
                "checks": [
                    ...
                    {"type": "has_attr", "tag": "img", "attr": "src", "points": 1.5, "label": "Tất cả <img> có thuộc tính src", "hint": "Thêm src=\"đường_dẫn_ảnh\" vào <img>"},
                    {"type": "has_attr", "tag": "img", "attr": "alt", "points": 1.0, "label": "Tất cả <img> có thuộc tính alt", "hint": "Thêm alt=\"mô tả ảnh\" vào <img>"},
                ]
            },
            {
                "name": "3. Mô tả ảnh",
    ...
    },
    {
        ...
        "description": "Tạo trang liên kết với <code>&lt;h1&gt;</code> tiêu đề, ít nhất 3 <code>&lt;a&gt;</code> có <code>href</code> và <code>target=\"_blank\"</code>, mỗi liên kết có <code>&lt;img&gt;</code> icon.",
        "required_tags": ["h1", "a", "img"],
        "criteria": [
            struct_criteria(2.5),
            {
                "name": "2. Thẻ liên kết bắt buộc",
                "points": 5.5,
                "checks": [
                    ...
                    {"type": "has_attr", "tag": "a", "attr": "href", "points": 1.5, "label": "Tất cả <a> có thuộc tính href", "hint": "Thêm href=\"https://...\" vào <a>"},
    ...
    },
    {
        ...
        "description": "Tạo trang với ảnh bọc trong liên kết: <code>&lt;a href=\"...\"&gt;&lt;img src=\"...\" alt=\"...\"&gt;&lt;/a&gt;</code>, có tiêu đề và mô tả.",
        "required_tags": ["a", "img"],
        "criteria": [
            struct_criteria(2.5),
            {
                "name": "2. Ảnh liên kết bắt buộc",
                "points": 5.5,
                "checks": [
    ...
    {
        "id": "f3_apply1",
        "group": "F3 — Bảng & Bố cục",
        "title": "F3 - Vận dụng 1: Bảng thời khóa biểu",
        "description": "Tạo bảng thời khóa biểu với <code>&lt;table&gt;</code> có <code>border</code>, hàng tiêu đề <code>&lt;thead&gt;</code> dùng <code>&lt;th&gt;</code>, ít nhất 5 hàng dữ liệu trong <code>&lt;tbody&gt;</code>.",
        "required_tags": ["table", "thead", "tbody", "tr", "th", "td"],
        "criteria": [
            struct_criteria(2.0),
            {
                "name": "2. Cấu trúc bảng",
                "points": 5.5,
                "checks": [
                    ...
                    {"type": "tag_count", "tag": "tr", "min": 6, "points": 1.5, "label": "Có ít nhất 6 hàng <tr> (1 tiêu đề + 5 dữ liệu)", "hint": "Thêm ít nhất 5 hàng <tr> vào <tbody>"},
                ]
            },
            {
                "name": "3. Thuộc tính bảng",
                "points": 1.0,
                "checks": [
                    {"type": "has_attr", "tag": "table", "attr": "border", "points": 1.0, "label": "<table> có thuộc tính border", "hint": "Thêm border=\"1\" vào <table>"},
                ]
            },
            syntax_criteria(1.5),
        ]
        ...
        "criteria": [
            struct_criteria(2.5),
            {
                ...
                "checks": [
                    ...
                    {"type": "has_attr", "tag": "iframe", "attr": "src", "points": 1.5, "label": "<iframe> có thuộc tính src", "hint": "Thêm src=\"https://www.youtube.com/embed/...\" vào <iframe>"},
    ...
    {
        "id": "f4_apply1",
        "group": "F4 — Đa phương tiện",
        "title": "F4 - Vận dụng 1: Video tự động phát, tắt tiếng",
        "description": "Nhúng video với <code>&lt;video&gt;</code> có <code>autoplay</code>, <code>muted</code>, <code>controls</code>, và <code>&lt;source&gt;</code> chỉ định file video.",
        ...
        "criteria": [
            struct_criteria(2.0),
            {
                ...
                "checks": [
                    ...
                    {"type": "has_tag", "tag": "source", "points": 1.0, "label": "Có thẻ <source> bên trong <video>", "hint": "Thêm <source src=\"video.mp4\" type=\"video/mp4\"> vào <video>"},
                    {"type": "has_bool_attr", "tag": "video", "attr": "autoplay", "points": 1.5, "label": "<video> có autoplay", "hint": "Thêm autoplay vào <video>"},
                    {"type": "has_bool_attr", "tag": "video", "attr": "muted", "points": 1.5, "label": "<video> có muted (tắt tiếng)", "hint": "Thêm muted vào <video>"},
    ...
    },
    {
        ...
        "description": "Tạo trang nhạc với <code>&lt;audio&gt;</code> có <code>controls</code>, <code>&lt;source&gt;</code>, tiêu đề <code>&lt;h2&gt;</code> và lời bài hát trong <code>&lt;p&gt;</code>.",
        ...
        "criteria": [
            struct_criteria(2.0),
            {
                ...
                "checks": [
                    ...
                    {"type": "has_tag", "tag": "source", "points": 1.0, "label": "Có thẻ <source> bên trong <audio>", "hint": "Thêm <source src=\"nhac.mp3\" type=\"audio/mpeg\"> vào <audio>"},
                    {"type": "has_bool_attr", "tag": "audio", "attr": "controls", "points": 1.5, "label": "<audio> có controls", "hint": "Thêm controls vào <audio>"},
                    {"type": "has_tag", "tag": "h2", "points": 1.0, "label": "Có thẻ <h2> tên bài hát", "hint": "Thêm <h2>Tên bài hát</h2>"},
                ]
            },
            {
                "name": "3. Lời bài hát",
    ...
    },
    {
        ...
        "description": "Tạo trang Portfolio với <code>&lt;img&gt;</code> ảnh đại diện (có alt), <code>&lt;video&gt;</code> giới thiệu, <code>&lt;audio&gt;</code> nhạc nền, tiêu đề <code>&lt;h1&gt;</code>.",
        ...
        "criteria": [
            struct_criteria(2.0),
            {
                ...
                "points": 6.5,
                "checks": [
                    {"type": "has_tag", "tag": "h1", "points": 0.5, "label": "Có thẻ <h1> tiêu đề", "hint": "Thêm <h1>Portfolio của tôi</h1>"},
                    {"type": "has_tag", "tag": "img", "points": 1.5, "label": "Có thẻ <img> ảnh đại diện", "hint": "Thêm <img src=\"anh.jpg\" alt=\"Ảnh đại diện\">"},
                    {"type": "has_attr", "tag": "img", "attr": "alt", "points": 1.0, "label": "<img> có thuộc tính alt", "hint": "Thêm alt=\"mô tả ảnh\" vào <img>"},
    ...
    # ===== F5 =====
    {
        ...
        "description": "Tạo form tìm kiếm với <code>&lt;form&gt;</code>, <code>&lt;input type=\"text\"&gt;</code> ô tìm kiếm, <code>&lt;button type=\"submit\"&gt;</code> nút tìm.",
    ...
    },
    {
        ...
        "description": "Tạo form đăng ký nhận tin với <code>&lt;input type=\"email\" required&gt;</code>, <code>&lt;label&gt;</code>, và nút submit.",
        ...
        "criteria": [
            struct_criteria(2.0),
            {
                ...
                "checks": [
                    ...
                    {"type": "has_bool_attr", "tag": "input", "attr": "required", "points": 1.0, "label": "<input> có required (bắt buộc)", "hint": "Thêm required vào <input type=\"email\">"},
                ]
            },
            {
                "name": "3. Nút submit",
    ...
    },
    {
        ...
        "description": "Tạo form khảo sát với <code>&lt;input type=\"radio\"&gt;</code> lựa chọn, <code>&lt;input type=\"checkbox\"&gt;</code> nhiều lựa chọn, <code>&lt;textarea&gt;</code> nhận xét.",
        ...
        "criteria": [
            struct_criteria(2.0),
            {
                ...
                "checks": [
                    ...
                    {"type": "has_tag", "tag": "textarea", "points": 1.5, "label": "Có thẻ <textarea> nhận xét", "hint": "Thêm <textarea rows=\"4\">...</textarea>"},
                ]
            },
            {
                "name": "3. Nút submit",
    ...
    },
    {
        ...
        "description": "Tạo trang đăng nhập với <code>&lt;input type=\"text\"&gt;</code> tên đăng nhập, <code>&lt;input type=\"password\"&gt;</code> mật khẩu, <code>&lt;label&gt;</code> cho mỗi input, nút đăng nhập.",
        "required_tags": ["form", "input", "label", "button"],
        "criteria": [
            struct_criteria(2.0),
            {
    ...
    },
    {
        ...
        "description": "Tạo form đăng ký câu lạc bộ với <code>&lt;select&gt;</code> chọn câu lạc bộ (ít nhất 3 <code>&lt;option&gt;</code>), <code>&lt;input type=\"email\"&gt;</code>, nút submit.",
        ...
        "criteria": [
            struct_criteria(2.0),
            {
                ...
                "checks": [
                    {"type": "has_tag", "tag": "form", "points": 1.5, "label": "Có thẻ <form>", "hint": "Thêm <form>...</form>"},
                    {"type": "has_tag", "tag": "select", "points": 1.5, "label": "Có thẻ <select> chọn câu lạc bộ", "hint": "Thêm <select name=\"club\">...</select>"},
        ...
        "criteria": [
            ...
            },
            {
                ...
                "checks": [
                    ...
                    {"type": "has_attr_any", "tags": ["td", "th"], "attr": "colspan", "points": 0.5, "label": "Có colspan hoặc rowspan", "hint": "Thêm colspan hoặc rowspan vào ô cần gộp"},
...
for ex in EXERCISES:
    ...
    print(f"{ex['id']:20s} | criteria_total={total:.1f} | checks_total={check_total:.1f}")
